<template>
 <div id="app" class="container-fluid">  	<!-- container-fluid - ocupa a tela toda -->
		<h1>Animações</h1>
		<hr>
	...
	<!-- usando nomes e atributos -->
		...
		<b-button variant="danger"
			@click="exibir2 = !exibir2">Alternar</b-button>
...
export default {
	...
	methods: {
		adicionarAluno() {
			...
			// this.alunos.push(s)
			const name = this.$faker().name.findName()
			this.alunos.push(name)
		},
		removerAluno(indice) {
