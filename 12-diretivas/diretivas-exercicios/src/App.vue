<template>
	...
	<hr>
	<p v-destaque-local2:fundo.atrasar.alternar="{cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
	<p v-destaque-local2:atrasar="{cor1: 'blue', atraso: 5000}">Usando diretiva personalizada</p>
	</div>
</template>
